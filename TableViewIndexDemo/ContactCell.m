...
- (void)layoutSubviews {
    ...
    _avatarImageView.frame = (CGRect){
        .origin.x = CGRectGetHeight(self.bounds) * 0.25f,
        .origin.y = CGRectGetHeight(self.bounds) * 0.25f,
        .size.width = CGRectGetHeight(self.bounds) * 0.5f,
        .size.height = CGRectGetHeight(self.bounds) * 0.5f
    };
    
    _nameLabel.frame = (CGRect){
        .origin.x = CGRectGetMaxX(_avatarImageView.frame)+10,
        .origin.y = 0,
